...
\begin{Representacion}
  ...
  \Rep[puntero(AVL)][a]{$a$ = NULL \oluego \\
  					   ...
  					   \hspace*{4em}$a\rightarrow altura$\footnote{La notación $a\rightarrow campo$, donde $a$ es un puntero a una tupla y $campo$ algun campo de esa tupla, equivale a decir ($*a$).$campo$.} = alto($a$) $\land$ \\
